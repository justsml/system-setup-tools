...
#### ORIGINALLY FROM DAN'S GIST: https://gist.github.com/justsml/f76fc9e751f76cc1074a9dcadac146bc
...
brew install zsh
echo "Next: installing Oh-My-ZSH\!"
...
echo "Next: Installing NodeJS v12.x.x\!"
nvm install 12
sleep 5s
...
# Never go into computer sleep mode - more useful on desktops
...
defaults write NSGlobalDomain AppleLanguages -array "en" # "es" "de" "nl"
...
## RESOURCES: 
# 1. https://github.com/rafeca/dotfiles/blob/cdea92451c5eaa1131e220c8db214a0eaa9b7780/osx/apps/iterm2.sh
# 2. https://www.iterm2.com/documentation-hidden-settings.html
...
curl -o "/tmp/Solarized Dark.itermcolors" -s https://raw.githubusercontent.com/rafeca/dotfiles/master/osx/apps/iterm2/Solarized%20Dark.itermcolors
/usr/libexec/PlistBuddy -c "Add 'Custom Color Presets':'Solarized Dark' dict" ~/Library/Preferences/com.googlecode.iTerm2.plist
/usr/libexec/PlistBuddy -c "Merge '/tmp/Solarized Dark.itermcolors' 'Custom Color Presets':'Solarized Dark'" ~/Library/Preferences/com.googlecode.iTerm2.plist

# Import Base16 - chalk Theme
curl -o "/tmp/Base16 Chalk Dark.itermcolors" -s https://raw.githubusercontent.com/rafeca/dotfiles/master/osx/apps/iterm2/Base16%20Chalk%20Dark.itermcolors
/usr/libexec/PlistBuddy -c "Add 'Custom Color Presets':'Base16 Chalk Dark' dict" ~/Library/Preferences/com.googlecode.iTerm2.plist
/usr/libexec/PlistBuddy -c "Merge '/tmp/Base16 Chalk Dark.itermcolors' 'Custom Color Presets':'Base16 Chalk Dark'" ~/Library/Preferences/com.googlecode.iTerm2.plist
...
/usr/libexec/PlistBuddy -c "Merge '/tmp/Base16 Chalk Dark.itermcolors' 'New Bookmarks':0" ~/Library/Preferences/com.googlecode.iterm2.plist
